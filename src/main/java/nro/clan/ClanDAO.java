...
public class ClanDAO {
    ...
    public static @NotNull ArrayList<Clan> load() {
    ...
    public static @NotNull ArrayList<Member> getMembers(int clanId, Clan clan) {
...
//            ps = null;
//            ps = conn.prepareStatement("UPDATE player SET clanid=-1,role_pt=2 WHERE clanid=?");
//            ps.setInt(1, _guildID);
//            ps.executeUpdate();
//            conn.commit();
            conn.close();
    ...
    synchronized public static void removeClanMember(int _userID) {
        ...
        try {
            ...
            ps.close();
//            ps = null;
//            ps = conn.prepareStatement("UPDATE player SET role_pt=2,clanid=-1 WHERE account_id=? LIMIT 1");
//            ps.setInt(1, _userID);
//            ps.executeUpdate();
//            conn.commit();
            conn.close();
    ...
    public static @NotNull ArrayList<Clan> searchClan(String text) {
        ArrayList<Clan> clans = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public static void deleteAllClan(Connection conn) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("DELETE FROM clan_member");
            ps.executeUpdate();
//            conn.commit();
            ps.close();
            ps = null;
            ps = conn.prepareStatement("DELETE FROM clan");
            ps.executeUpdate();
//            conn.commit();
            ps.close();
        } catch (Exception ex) {
    ...
    public static void createNewClan(Connection conn, Clan clan) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("INSERT INTO clan(id, name, leader_id, img_id, tcreate, topen) VALUES(?,?,?,?,?,?)");
            ps.setInt(1, clan.id);
...
//            conn.commit();
    ...
    public static void addNewMember(Connection conn, int clanId, Member member) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("INSERT INTO clan_member(clan_id, player_id, name, head, headicon, body, leg, role, power_point) VALUES(?,?,?,?,?,?,?,?,?)");
            ps.setInt(1, clanId);
