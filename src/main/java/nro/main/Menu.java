...
public class Menu {
    ...
    public void confirmMenu(@NotNull Player p, @NotNull Message m) throws IOException, SQLException, InterruptedException {
...
//            }
            ...
            case 42:
            { //QUOC VUONG MO GIOI HAN SUC MANH
                if(p.map.id == 43) {
                    if(p.menuID == -1) {
                        if(select == 0) {
                        ...
                        if(select == 0) {
                            if(p.limitPower >= 24) {
                                ...
                                if(p.power >= 18000000000L) {
                                    if(p.limitPower < 24 && p.vang >= 500000000) {
                                        p.vang -= 500000000;
                                        p.limitPower += 1;
                                        Service.gI().buyDone(p);
                        ...
                        if(select == 0) {
                            if(p.detu != null && p.havePet == (byte)1) {
                                if(p.detu.limitPower >= 7) {
                                    ...
                                    if(p.power >= 18000000000L) {
                                        if(p.detu.limitPower < 8 && p.vang >= 500000000) {
                                            p.vang -= 500000000;
                                            p.detu.limitPower += 1;
                                            Service.gI().buyDone(p);
                    ...
                    if (p.taskId >= (short) 23) {
                        if (select == 0) {
                            if (p.map.id != 102) {
                                ...
                                Service.gI().teleportByTauNgam(p, 102, 31000);
                            } else {
            ...
            { //RONG THAN TRAI DAT
                if(p.menuID == -1) {
                    if(select == 0){ //DEP TRAI NHAT VU TRU
                        Item _AVATARVIP = new Item(ItemSell.getItemNotSell((int)p.gender + 227));
                        ...
                        if(p.havePet == 1 && (p.detu.power >= 1500000000L)) {
                            int rdSkill2 = Util.nextInt(0, 10);
                            if(rdSkill2 <= 1) {
                    ...
                    if(p.menuID == -1) {
                        ...
                        if(select == 3){ //Nhap ngoc rong
                            ...
                            try {
                                msg = new Message(-81);
                                msg.writer().writeByte(0);
                                msg.writer().writeUTF("Vào hành trang\nChọn trang bị kích hoạt (Kirin, Songoku, KI Namec, Pikkoro Daimao, Liên Hoàn, Kakarot, Nappa)\nChọn trang bị thần linh tương ứng cùng loại, cùng hành tinh\nSau đó chọn 'Nâng cấp'");
                                msg.writer().writeUTF("Ta sẽ phù phép\ncho trang bị kích hoạt của ngươi\ntrở nên mạnh mẽ");
                                msg.writer().flush();
                                p.session.sendMessage(msg);
                                msg.cleanup();
                            } catch (Exception e) {
...
//                    Util.log("select: " + select);
                    if(p.menuID == 0 && select == 0) { //bua 1 gio
                        ...
                        break;
                    } else if(p.menuID == 6 && select == 0) {
                        ItemService.gI().confirmUpgradeItemActive(p);
                        break;
                    }
                    break;
                }
                ...
                if(p.map.id == 5) {
                    if(p.menuID != -1)
                    {
                        ...
                        if(p.menuID == 2 && select == 0) { //titan
                            ...
                            GotoMap(p, 153);
                            break;
                        } else if(p.menuID == 4 && select == 0 && p.giftEvent > 0) {
                            if(p.getIndexBagNotItem() != -1) {
                                if (HelperDAO.updateEvent(p)) {
                                    //                                Util.log("ABC");
                                    Item petTemp = ItemSell.getItemNotSell(Constant.ITEM_PET[Util.nextInt(0, Constant.ITEM_BUFF.length)]);
                                    Item petEvent = new Item(petTemp);

                                    petEvent.itemOptions.clear();
//                                    int add = Util.nextInt(6, 12);
                                    if (Util.nextInt(0, 100) > 90) {
//                                        add = Util.nextInt(10, 14);
//                                        petEvent.itemOptions.add(new ItemOption(50, add));
//                                        if(petEvent.template.id == 1001) {
//                                            petEvent.itemOptions.add(new ItemOption(5, Util.nextInt(6, 14)));
//                                        } else if(petEvent.template.id == 740) {
//                                            if(Util.nextInt(0, 100) < 90) {
//                                                petEvent.itemOptions.add(new ItemOption(77, Util.nextInt(5, 8)));
//                                            } else {
//                                                petEvent.itemOptions.add(new ItemOption(77, Util.nextInt(8, 10)));
//                                            }
//                                        } else {
//                                            petEvent.itemOptions.add(new ItemOption(103, Util.nextInt(6, 14)));
//                                        }
                                        petEvent.itemOptions.add(new ItemOption(50, Util.nextInt(6, 12)));
                                        petEvent.itemOptions.add(new ItemOption(77,  Util.nextInt(6, 12)));
                                        petEvent.itemOptions.add(new ItemOption(103,  Util.nextInt(6, 12)));
                                    } else {
                                        petEvent.itemOptions.add(new ItemOption(50, Util.nextInt(6, 10)));
                                        petEvent.itemOptions.add(new ItemOption(77, Util.nextInt(6, 10)));
                                        petEvent.itemOptions.add(new ItemOption(103, Util.nextInt(6, 10)));
//                                        if(petEvent.template.id == 1001) {
//                                            petEvent.itemOptions.add(new ItemOption(5, Util.nextInt(6, 11)));
//                                        } else if(petEvent.template.id == 740) {
//                                            petEvent.itemOptions.add(new ItemOption(77, Util.nextInt(5, 11)));
//                                        } else {
//                                            petEvent.itemOptions.add(new ItemOption(103, Util.nextInt(6, 11)));
//                                        }
                                    }

//                                    petEvent.itemOptions.add(new ItemOption(94, Util.nextInt(1, 6)));

                                    if (p.giftEvent < 2) {
                                        if (Util.nextInt(0, 100) > 20) {
                                            int day = Util.nextInt(3, 8);
                                            petEvent.itemOptions.add(new ItemOption(93, day));
                                            petEvent.timeHSD = System.currentTimeMillis() + (long) day * 86400000;
                                        }
                                    }
                                    p.giftEvent = 0;
                                    p.addItemToBag(petEvent);
                                    Service.gI().updateItemBag(p);
                                    p.sendAddchatYellow("Bạn vừa nhận được " + petEvent.template.name);
                                } else {
                                    p.sendAddchatYellow("Lỗi nhận item");
                                }
                            } else {
                    ...
                    if(select == 2){
                        ...
                        p.menuID = select;
                    } else if(select == 4 && p.giftEvent > 0) {
                        doMenuArray(p,idNpc,"Nhận quà sự kiện nạp",new String[]{"Pet\nsự kiện"});
                        p.menuID = select;
                    }
                }
                break;
                                ...
                                if (countDAUHT < maxDauTheo) {
                                    ...
                                    if (indexDAU != -1) {
                                        ...
                                        if (p.getBagNull() == 0) {
                                            ...
                                            Item dauThuHoach = new Item(ItemSell.getItemNotSell(itemDAUTHAN));
            ...
            case 2:
            {
                if (p.map.id == 22) {
                    if (p.menuID == -1) {
                        ...
                        if (select == 1) {
//                            if(p.id == 1 || p.id == 2) {
                            doMenuArray(p, idNpc, "Bạn đang có " + p.goldStone + " thỏi vàng (Nhận mỗi lần tối đa x99999, nếu ít hơn x99999 sẽ tự động nhận hết)", new String[]{"Nhận", "Đóng"});
                            p.menuID = select;
//                            } else {
...
//                            }
                        ...
                        if (select == 3) {
                            doMenuArray(p, idNpc, "Con có muốn nhận đệ tử, sẽ thay thế đệ tử hiện tại nếu có", new String[]{"OK", "Đóng"});
                            p.menuID = select;
                            break;
                        }
                    } else if(p.menuID == 1) {
                        if (select == 0) {
                            int quantityGold = Math.min(p.goldStone, 99999);
                            if(quantityGold > 0) {
                                if(p.getIndexBagNotItem() != -1) {
                                    if (HelperDAO.payGoldDB(p, quantityGold)) {
                                        Item itemBuff = ItemSell.getItemNotSell(457);
                                        Item _itemBuff = new Item(itemBuff);
                                        _itemBuff.quantity = quantityGold;
                                        _itemBuff.itemPay = true;
                                        p.addItemToBag(_itemBuff);
                                        Service.gI().updateItemBag(p);
                                        p.sendAddchatYellow("Bạn vừa nhận được x" + quantityGold + " thỏi vàng");
                                    } else {
                                        p.sendAddchatYellow("Nhận vàng thất bại");
                                    }
                                } else {
                                    p.sendAddchatYellow("Hành trang không còn chỗ trống");
                                }
                            } else {
                                p.sendAddchatYellow("Nhận vàng thất bại");
                            }
...
//        Map mapold = p.map;
//        Util.log("map old : " + p.map.template.id);
        Map maptele = MainManager.getMapid(id);
//        Util.log("map new : " + maptele.template.id);

        if(maptele != null) {
            Controller.getInstance().teleportToMAP(p, maptele);
        } else {
            p.sendAddchatYellow("Lỗi vào map");
        }
    }

    public  void openUINpc(@NotNull Player p, @NotNull Message m) throws IOException {
        ...
        m = new Message(33);
        if(p.menuNPCID == 75 && (p.map.id == 7 || p.map.id == 166)){
            if(p.map.id == 7) {
                doMenuArray(p,idnpc,"Chào bạn, tôi sẽ đưa bạn tới hành tinh Cereal",new String[]{"Đồng ý","Từ chối"});
            } else if(p.map.id == 166) {
                doMenuArray(p,idnpc,"Tôi sẽ đưa bạn quay trở về hành tinh của mình",new String[]{"Đồng ý","Từ chối"});
            }
            return;
        }
//        else if(p.menuNPCID == 74 && p.map.id == 5) {
...
//                } else {
                doMenuArray(p,idnpc,Text.get(0, 0),new String[]{"GiftCode","Nhận Vàng","Nhận Ngọc","Nhận Đệ"});
//                }
            }
            return;
...
//            doMenuArray(p,idnpc,"Ta có thể giúp gì cho con",new String[]{"Nói chuyện","Tính năng","Đá nâng cấp","Bang hội"});
            doMenuArray(p,idnpc,"Ta có thể giúp gì cho con",new String[]{"Nói chuyện","Tính năng","BXH","Bang hội","Sự kiện"});
            return;
...
//                && p.clan.members.size() >= 5 && p.gender == (byte)2) {
    ...
    public int NpcAvatar(@NotNull Player p, int npcID){
