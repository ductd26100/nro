...
//    public Detu(Player n) {
    public Boss(int Id, byte type, short xBoss, short yBoss) {
        ...
        if(type == 1) {
            ...
            this.head = 294;
            this.hpGoc = Util.nextInt(500000000, 1500000001);
            this.mpGoc = 500;
            this.hp = this.hpGoc;
            this.mp = this.mpGoc;
            this.damGoc = (int)(Util.nextInt(2000000, 20000001)*0.1);
            this.defGoc = 0;
            this.critGoc = 0;
            ...
            this.typePk = (byte)5;
            this.isBOSS = true;
        } else if(type == (byte)52) { //Elec
            this.name = "Elec";
            this.head = 1182;
            this.hpGoc = 1300000000;
            this.mpGoc = 1300000000;
            this.hp = this.hpGoc;
            this.mp = this.mpGoc;
            this.damGoc = 200000;
            this.defGoc = 2000;
            this.critGoc = 20;
            this.hpFull = 1300000000;
            this.mpFull = 1300000000;
            this.damFull = 200000;
            this.defFull = 0;
            this.critFull = 0;
            this.x = xBoss;
            ...
            this.typePk = (byte)5;
            this.isBOSS = true;
        } else if(type == (byte)54) { //Mackie
            this.name = "Mackie";
            this.head = 1188;
            this.hpGoc = 1400000000;
            this.mpGoc = 1400000000;
            this.hp = this.hpGoc;
            this.mp = this.mpGoc;
            this.damGoc = 230000;
            this.defGoc = 2000;
            this.critGoc = 20;
            this.hpFull = 1400000000;
            this.mpFull = 1400000000;
            this.damFull = 230000;
            this.defFull = 0;
            this.critFull = 0;
            this.x = xBoss;
    ...
    public boolean getTypePKBoss() {
        return (this._typeBoss <= (byte)10 || this._typeBoss == (byte)15 || (this._typeBoss >= (byte)18 && this._typeBoss == (byte)23)
        || this._typeBoss >= (byte)26);
    }
