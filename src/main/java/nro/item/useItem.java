...
//                            }
            ...
            {//MAY DO CAPSULE KY BI VA CAC ITEM BUFF
                ...
                if(p.cItemBuff < (byte)5 || (p.cItemBuff == (byte)5 && hasItem)) {
                    if(!hasItem) {
                        p.cItemBuff = (byte)(p.cItemBuff + 1);
                ...
                if((item.id == 402 || item.id == 403 || item.id == 404 || item.id == 759) && p._canUSEITEM)
                {
                    ...
                    if(p.detu != null && p.havePet == (byte)1)
                    {
                        ...
                        if(p.detu.listSkill.get(0).point < 7 && item.id == 402) {
                            ...
                            p.detu.listSkill.get(0).point = Math.min((p.detu.listSkill.get(0).point + 1), 7);
                            ...
                            p.detu.listSkill.get(1).point = Math.min((p.detu.listSkill.get(1).point + 1), 7);
                            ...
                            p.detu.listSkill.get(2).point = Math.min((p.detu.listSkill.get(2).point + 1), 7);
                            ...
                            p.detu.listSkill.get(3).point = Math.min((p.detu.listSkill.get(3).point + 1), 7);
        ...
        //                    Service.gI().updateItemBag(p);
                ...
                else if (item.id == 521)
                {
                    if(p.timeEndTDLT == 0)
                    {
                        ...
                        p.timeEndTDLT = (long)(System.currentTimeMillis() + (long)(_timeP* 60000L));
                        ...
                        if(_timeP > 0) {
                            resetTDLT.schedule(rsTDLT, (long)(_timeP* 60000L));
                        }
                    }
                    else
                    {
...
//                    _AVATARVIP.itemOptions.add(new ItemOption(77, Util.nextInt(15, 21)));
                ...
                else if(item.id == 457 && p.ItemBag[(byte)index].quantity >= 1)
                {
                    ...
                    Service.gI().updateItemBag(p);
                    p.vang = Math.min(((long) p.vang + 500000000), 2000000000L);
                    ...
                    return;
                        ...
                        item.id == 1039 || item.id == 1040 || item.id == 1046 || item.id == 1107 || item.id == 1114 || item.id == 1216)
                {
                    ...
                    if((p.map.id != 21 && p.map.id != 22 && p.map.id != 23) && (!p.isdie && p.detu != null && !p.detu.isdie && p.havePet == 1)) {
                        if((System.currentTimeMillis() - p.tFusion) > 0) {
                            ...
                            if(p.NhapThe == 0){
                                ...
                                p.detu.hp = Math.min(p.detu.hp, p.detu.getHpFull());
